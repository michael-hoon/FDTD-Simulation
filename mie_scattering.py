...
for w in wvl:
    ...
    sim.use_output_directory(f"Test4_{w}") #output all to default directory mie_scattering-out/
    sim.run(
        ...
        mp.at_every(1, mp.output_png(mp.Ey, "-Zc /home/draco/miniconda3/envs/mp/share/h5utils/colormaps/dkblueredblack -C $EPS")),
        until=30)
